	...
	<section class="cmt_area py-5">
		<div class="container">
			<div class="row">
				<div class="col-md-12 py-5">
					<div class="technology">
						<h2>REFRIGERATION AND AIR CONDITIONING (672)</h2>
					</div>
				</div>
			<!--start 1st semester -->
			<div class="row align-items-center gx-5">
				...
				<?php  
				$stm= $pdo->prepare("SELECT * FROM sell_books WHERE dpt_name=? AND sem_name=?");
				$stm->execute(array('rac','1st'));
				$Ubooks =$stm->rowCount();
				if ($Ubooks != 0) {
					$count = 0;
